...
public class ImGuiLayer {
    ...
    private String glslVersion = "#version 330 core"; // We can initialize our renderer with different versions of the GLSL
...
//        glfwGetWindowSize(windowPtr, Window.getWidth(), Window.getHeight());
//        glfwGetFramebufferSize(windowPtr, Window.getWidth(), Window.getHeight());
